...
- H2 Console: **http://localhost:8080/h2-console** (JDBC URL: `jdbc:h2:mem:flourishtravel`, user: `sa`, password để trống)
...
MOMO_ACCESS_KEY=
MOMO_SECRET_KEY=
MOMO_IPN_URL=http://localhost:8080/payments/momo/ipn
...
API base (local): **http://localhost:8080** — production public: **https://&lt;domain&gt;/api**
...
3. Demo local: [chatbot-demo.html](http://localhost:8080/chatbot-demo.html) (vd: "Tour biển 3 ngày").
